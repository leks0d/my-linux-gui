...
namespace mango
{
	...
	class GroupOperateView: public View
	{
	public:
		GroupOperateView(void);
		GroupOperateView(const TCHAR* title, View* parent, Rect* rect, int style, int show = SW_NORMAL);
		virtual ~GroupOperateView(void);
	...
	public:
		...
		ArrayMediaInfo mArrayMediaInfo;
	private:
