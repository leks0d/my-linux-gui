...
#include <ft2build.h>
#include "ftraster.h"
#include "d:\freetype\include\freetype\internal\ftcalc.h"   /* for FT_MulDiv only */
...
#include "d:\freetype\include\freetype\internal\ftdebug.h"        /* for FT_TRACE() and FT_ERROR() */
