...
#include <ft2build.h>
#include "/freetype/include/freetype/internal/sfnt.h"
  ...
  */
                                ...
                                FT_ULong*  astrike_index )
  {
    ...
    *astrike_index = 0x7FFFFFFFUL;
    ...
    //Fibo return tt_face_set_sbit_strike( face, &req, astrike_index );
	return 0 ; //Fibo
  }
  ...
  const SFNT_Interface  sfnt_interface =
  {
	...
	0, //Fibo    tt_find_sbit_image,
	0, //Fibo    tt_load_sbit_metrics,
#endif
