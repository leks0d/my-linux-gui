...
namespace mango
{
	...
	class SdcardInsertView: public View
	{
	public:
		SdcardInsertView(void);
		SdcardInsertView(const TCHAR* title, View* parent, Rect* rect, int style, int show = SW_NORMAL);
		virtual ~SdcardInsertView(void);
		void initView();
	public:
