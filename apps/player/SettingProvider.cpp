...
{	
	...
	void SettingProvider::dataBaseInit(void){
		insert(SETTING_BRIGHTNESS_ID,180,SETTING_BRIGHTNESS_NAME);
		...
		insert(SETTING_PLAYLIST_ORDER_ID,-1,SETTING_PLAYLIST_ORDER_NAME);
		insert(SETTING_DIGITAL_FILTER_ID,0,SETTING_DIGITAL_FILTER_NAME);
